...
type UserLogin struct {
	Username string `json:"username" bson:"username" example:"userbaru"`
	Password string `json:"password" bson:"password" example:"rahasiakita"`
...
type RegisterResponse struct {
	...
	ID      string `json:"id,omitempty" example:"64b3f6d7e9b0b4a4e8d3f6d7"`
}
